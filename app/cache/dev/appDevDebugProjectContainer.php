...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'darna', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\Projet\\UserBundle\\Resources\\config\\doctrine') => 'Projet\\UserBundle\\Entity'));
        $b->setGlobalBasename('mapping');

        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Projet\\DarnaBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Projet\\MapsBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Projet\\MailBundle\\Entity')));

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($b, 'Projet\\UserBundle\\Entity');
        $d->addDriver($c, 'Projet\\DarnaBundle\\Entity');
        $d->addDriver($c, 'Projet\\MapsBundle\\Entity');
        $d->addDriver($c, 'Projet\\MailBundle\\Entity');
        ...
        $e->setEntityNamespaces(array('ProjetUserBundle' => 'Projet\\UserBundle\\Entity', 'ProjetDarnaBundle' => 'Projet\\DarnaBundle\\Entity', 'ProjetMapsBundle' => 'Projet\\MapsBundle\\Entity', 'ProjetMailBundle' => 'Projet\\MailBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_dc8edcfcb3f24d21465320d85f617af6d7da5d4c6519ab29de97368564c3ad71');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Projet\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Projet\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Projet\\UserBundle\\Entity\\User');
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('agenceespritpidev@gmail.com');
        $a->setPassword('123456789Mm!');
        $a->setAuthMode('login');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Projet\\UserBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Projet\\DarnaBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Projet\\MapsBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Projet\\MailBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Projet\\UserBundle/Resources/views'), 'ProjetUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Projet\\DarnaBundle/Resources/views'), 'ProjetDarna');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\nomaya\\social-bundle\\Nomaya\\SocialBundle/Resources/views'), 'NomayaSocial');
        $instance->addPath(($this->targetDirs[3].'\\src\\Projet\\MapsBundle/Resources/views'), 'ProjetMaps');
        $instance->addPath(($this->targetDirs[3].'\\src\\Projet\\MailBundle/Resources/views'), 'ProjetMail');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ProjetDarnaBundle' => 'Projet\\DarnaBundle\\ProjetDarnaBundle',
                'NomayaSocialBundle' => 'Nomaya\\SocialBundle\\NomayaSocialBundle',
                'ProjetMapsBundle' => 'Projet\\MapsBundle\\ProjetMapsBundle',
                ...
                'ProjetMailBundle' => 'Projet\\MailBundle\\ProjetMailBundle',
            ...
            'mailer_user' => 'agenceespritpidev@gmail.com',
            'mailer_password' => '123456789Mm!',
            'locale' => 'en',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'agenceespritpidev@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => '123456789Mm!',
            ...
            'links.facebook' => array(
                'network' => 'facebook',
                'url' => 'https://www.facebook.com/profile.php?id=100009136067525&fref=ts',
                'theme' => 'default',
            ),
            'links.googleplus' => array(
                'network' => 'googleplus',
                'url' => 'https://plus.google.com/u/0/109322886005854595922',
                'theme' => 'default',
            ),
