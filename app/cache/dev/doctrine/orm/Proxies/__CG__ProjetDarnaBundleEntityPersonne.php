 ...
 */
class Personne extends \Projet\DarnaBundle\Entity\Personne implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Projet\\DarnaBundle\\Entity\\Personne' . "\0" . 'nom', '' . "\0" . 'Projet\\DarnaBundle\\Entity\\Personne' . "\0" . 'prenom', '' . "\0" . 'Projet\\DarnaBundle\\Entity\\Personne' . "\0" . 'datenaiss', '' . "\0" . 'Projet\\DarnaBundle\\Entity\\Personne' . "\0" . 'tel', '' . "\0" . 'Projet\\DarnaBundle\\Entity\\Personne' . "\0" . 'ville', '' . "\0" . 'Projet\\DarnaBundle\\Entity\\Personne' . "\0" . 'pays', 'password', 'email', '' . "\0" . 'Projet\\DarnaBundle\\Entity\\Personne' . "\0" . 'adresse', '' . "\0" . 'Projet\\DarnaBundle\\Entity\\Personne' . "\0" . 'type', '' . "\0" . 'Projet\\DarnaBundle\\Entity\\Personne' . "\0" . 'idagence');
        }
