...
namespace Projet\UserBundle\Redirection;
...
class AfterLoginRedirection implements AuthenticationSuccessHandlerInterface
{
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token)
    {
        ...
        $rolesTab = array_map(function($role){         // Tranform this list in array
        ...
        // o(in_arrtherwise, if is a commercial user we redirect to the crm area
     
        // otherwise we redirect user to the member area
        else
            $redirection = new RedirectResponse($this->router->generate('home_gerant'));
